		...
		<div class="container">
			<div class="form-outer text-center d-flex align-items-center">
				<div class="form-inner">
					...
					<?php echo form_open('login/newpass/' . $token); ?>
						<div class="form-group-material">
							<input type="password" name="senha" class="input-material" id="senha">
							<label class="label-material" for="senha">Nova Senha</label>
							<?php
								echo form_error('senha', '<p class="error-feedback">');
							?>
						</div>
						<div class="form-group-material">
							<input type="password" name="confirm-senha" class="input-material" id="confirm-senha">
							<label class="label-material" for="confirm-senha">Confirmação nova senha</label>
							<?php
								echo form_error('confirm-senha', '<p class="error-feedback">');
